...
exports = module.exports = {
    ...
    get events() { return require('judpack-common').events },
    get configparser() { return require('judpack-common').ConfigParser },
    get PluginInfo() { return require('judpack-common').PluginInfo },
    get CordovaError() { return require('judpack-common').CordovaError }
