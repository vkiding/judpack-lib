...
var selfEvents = require('judpack-common').events;
...
function Api(platform, platformRootDir, events) {
    ...
    if(AndroidStudio.isAndroidStudioProject(self.root) === true) {
      ...
      this.locations.configXml = path.join(self.root, 'judplugin/src/main/res/xml/config.xml');
      this.locations.strings = path.join(self.root, 'judplugin/src/main/res/xml/strings.xml');
      this.locations.manifest = path.join(self.root, 'judplugin/src/main/AndroidManifest.xml');
      this.locations.www = path.join(self.root, 'judplugin/src/main/assets/www');
      this.locations.res = path.relative(self.root, path.join(self.root, 'judplugin/src/main/res'));
    }
}
