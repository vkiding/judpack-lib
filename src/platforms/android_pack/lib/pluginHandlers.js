...
var handlers = {
    'source-file':{
        install:function(obj, plugin, project, options) {
            ...
            if(options && options.android_studio === true) {
              dest = path.join('judplugin/src/main/java', obj.targetDir.substring(4), path.basename(obj.src));
            }
    ...
    'lib-file':{
        install:function(obj, plugin, project, options) {
            ...
            if(options && options.android_studio === true) {
              dest = path.join('judplugin/libs', path.basename(obj.src));
            }
            copyFile(plugin.dir, obj.src, project.projectDir, dest, !!(options && options.link));
        },
        uninstall:function(obj, plugin, project, options) {
    ...
    'resource-file':{
        ...
        install:function(obj, plugin, project, options) {
            ...
            if(options && options.android_studio === true) {
                dest = path.join('judplugin/src/main/', path.normalize(obj.target));
            }
            // JUD_HOOK_END
            copyFile(plugin.dir, obj.src, project.projectDir, dest, !!(options && options.link));
        },
